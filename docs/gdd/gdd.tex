...
A tela de \textit{Play Game} é a tela onde o jogador poderar criar um novo jogo ou carregar algum \textit{slot} salvo anteriormente.
...
A tela de \textit{Options} é a tela onde o jogador poderar configurar o volume do e a resolução do jogo da maneira que este achar mais adequado.
