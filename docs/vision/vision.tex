...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.3]{pictures/history.png}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.4]{pictures/tower.png}
\caption{Torre}
\label{Torre}
\end{figure}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.3]{pictures/mechanics.png}
\caption{Mecânicas}
\label{Mecânicas}
\end{figure}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.3]{pictures/resources.png}
...
\begin{figure}[!htp]
\centering
\includegraphics[scale=0.3]{pictures/Dungeon_Crawler.png}
